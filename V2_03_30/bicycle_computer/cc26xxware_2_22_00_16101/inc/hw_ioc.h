/******************************************************************************
*  Filename:       hw_ioc_h
*  - Peripherals haben 32 Flags (DIO 0 bis DIO31).
*    Diese werden Register offset genannt
*  - MCU, GPIO sind beides Peripherals mit ihrer eigenen BasisAdresse
* */
...
// IOC component. baek es sind die Pins/Flags einer Region/Peripherals
//
//*****************************************************************************

// The 2 less significant bits are not used !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
