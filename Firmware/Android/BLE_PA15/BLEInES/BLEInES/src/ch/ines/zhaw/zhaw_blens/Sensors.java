		...
		public void onLeScan(final BluetoothDevice device, int rssi,
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					// Bicycle Computer Vendor 9
					// Im Rahmen der Projektarbeit 15
					...
					if(custNr==9){
						...
						// Speed:
						long inData;
						double circumference, speed, time;

						double diameter = 64;	//[cm]
						...
						circumference = (diameter/100)*pi;
						speed = (circumference / (time/1000)) * 3.6;

						String actSensor;
						actSensor="Bicycle Computer(Vendor: 9)\nID: "+sensId;

						String actMeasure = "Speed:\u0009"+myFormat.format(speed)+"\u0009"+"km/h"+"\nTime(in):\u0009"+myFormat.format(time)+"\u0009"+"ms"+"\nWheel Diameter=\u0009"+myFormat.format(diameter)+"\u0009"+"cm";

						addSensor(actSensor, actMeasure, myFormat.format(speed)+" km/h");
